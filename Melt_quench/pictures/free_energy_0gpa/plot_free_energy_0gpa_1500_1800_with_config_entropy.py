...
def main():
    ...
    out_path = ROOT / "free_energy_0GPa_1500K_1800K_with_config_entropy.png"
    fig.savefig(out_path, dpi=600, bbox_inches="tight")
    fig.savefig(ROOT / "free_energy_0GPa_1500K_1800K_with_config_entropy.pdf", bbox_inches="tight")
    fig.savefig(ROOT / "free_energy_0GPa_1500K_1800K_with_config_entropy.eps", dpi=600, bbox_inches="tight")
    plt.close(fig)
