...
SIXFOLD_SUMMARY = DATA_DIR / "sixfold_fraction_summary_1800k.csv"
POTENTIAL_DATA = DATA_DIR / "potential_energy_0gpa_1800k.csv"
TEMPERATURE = 1800.0
COMPOSITIONS = [
...
def main():
    ...
    ax.legend(handles=bar_handles + [line_handle, fit_handle], frameon=False, loc="upper left", ncol=1)

    fig.tight_layout(pad=0.4)
    png_path = ROOT / "sixfold_fraction_energy_overlay_1800K_3c.png"
    fig.savefig(png_path, dpi=600, bbox_inches="tight")
    fig.savefig(ROOT / "sixfold_fraction_energy_overlay_1800K_3c.pdf", bbox_inches="tight")
    fig.savefig(ROOT / "sixfold_fraction_energy_overlay_1800K_3c.eps", dpi=600, bbox_inches="tight")
    plt.close(fig)
