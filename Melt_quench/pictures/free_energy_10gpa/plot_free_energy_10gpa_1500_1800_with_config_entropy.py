...
def main():
    ...
    axes[0].set_ylabel(r"$H-T(S_{vib}+S_{mix})$ [eV/atom]", fontsize=6)
    fig.tight_layout(pad=0.45, w_pad=0.7)
    out_path = ROOT / "free_energy_10GPa_1500K_1800K_with_config_entropy.png"
    fig.savefig(out_path, dpi=600, bbox_inches="tight")
    fig.savefig(ROOT / "free_energy_10GPa_1500K_1800K_with_config_entropy.pdf", bbox_inches="tight")
    fig.savefig(ROOT / "free_energy_10GPa_1500K_1800K_with_config_entropy.eps", dpi=600, bbox_inches="tight")
    plt.close(fig)
