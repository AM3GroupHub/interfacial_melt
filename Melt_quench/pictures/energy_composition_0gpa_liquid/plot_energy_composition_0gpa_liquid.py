...
SOURCE = ROOT / "data" / "csv" / "normalized_energy_0GPa_liquid.csv"
...
def plot_temperature(rows, temperature):
    ...
    png_path = ROOT / f"energy_composition_0GPa_liquid_{temperature:.0f}K_deg5.png"
    pdf_path = ROOT / f"energy_composition_0GPa_liquid_{temperature:.0f}K_deg5.pdf"
