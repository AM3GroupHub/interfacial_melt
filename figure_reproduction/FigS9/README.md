...
Fe-B free-energy convex hulls at 1800 K and 0/5/10 GPa, using the fine-tuned MACE-MH-1 r2SCAN head. The original PDF is `reference.pdf`.
...
Source: `response/DFT_MACE/Fe-B/`. These inputs are distinct from Fig. S7.
