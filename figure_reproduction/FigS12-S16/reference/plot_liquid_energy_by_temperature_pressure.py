...
SOURCES = {
    "0 GPa": ROOT / "0GPa_liquid" / "normalized_energy_0GPa_liquid.csv",
    "10 GPa": ROOT / "10GPa_liquid" / "normalized_energy_10GPa_liquid.csv",
}
...
def main():
    ...
    out_dir = ROOT / "liquid_energy_by_temperature_pressure"
