...
#    ax.axhline(0, color="gray", linestyle="-", linewidth=0.8, alpha=0.9)
...
def main():
    ...
    out_path = OUT_DIR / "free_energy_0GPa_1500K_1800K.png"
    fig.savefig(out_path, dpi=600, bbox_inches="tight")
    fig.savefig(OUT_DIR / "free_energy_0GPa_1500K_1800K.pdf", bbox_inches="tight")
    plt.close(fig)
