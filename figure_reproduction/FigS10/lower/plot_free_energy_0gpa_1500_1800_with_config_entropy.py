...
SOURCE = ROOT / "data" / "normalized_energy_0GPa_liquid.csv"
OUT_DIR = ROOT / "output"
...
def plot_panel(ax, panel, baseline):
    ...
    ax.text(0.735, 0.145, r"FeB$_4$", fontsize=6, ha="center", va="center")
...
def main():
    ...
    out_path = OUT_DIR / "free_energy_0GPa_1500K_1800K_with_config_entropy.png"
    fig.savefig(out_path, dpi=600, bbox_inches="tight")
    fig.savefig(OUT_DIR / "free_energy_0GPa_1500K_1800K_with_config_entropy.pdf", bbox_inches="tight")
    plt.close(fig)
