...
PRESSURE_DIRS = {
    "0 GPa": ROOT / "data" / "0GPa_liquid",
    "10 GPa": ROOT / "data" / "10GPa_liquid",
}
...
def main():
    # S18-S28, respectively; no unrelated energy tables are needed.
    formulas = ["Fe324B36", "Fe128B32", "Fe252B108", "Fe216B144", "Fe200B200",
                "Fe160B240", "Fe120B280", "Fe135B405", "Fe72B288", "Fe81B459", "Fe54B486"]
    for folder in PRESSURE_DIRS.values():
