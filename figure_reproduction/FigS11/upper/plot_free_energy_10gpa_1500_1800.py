...
plt.rcParams["font.family"] = "Arial"  # Font embedded in the original PDF.


ROOT = Path(__file__).resolve().parent
SOURCE = ROOT / "data" / "normalized_energy_10GPa_liquid.csv"
OUT_DIR = ROOT / "output"
...
def main():
    ...
    out_path = OUT_DIR / "free_energy_10GPa_1500K_1800K.png"
    fig.savefig(out_path, dpi=600, bbox_inches="tight")
    fig.savefig(OUT_DIR / "free_energy_10GPa_1500K_1800K.pdf", bbox_inches="tight")
    plt.close(fig)
