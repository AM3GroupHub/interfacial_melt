...
plt.rcParams["font.family"] = "DejaVu Sans"  # Font embedded in the original PDF.


ROOT = Path(__file__).resolve().parent
SOURCE = ROOT / "data" / "free_energy_10gpa_1500_1800.csv"
OUT_DIR = ROOT / "output"
...
def main():
    ...
    out_path = OUT_DIR / "free_energy_10GPa_1500K_1800K_with_config_entropy.png"
    fig.savefig(out_path, dpi=600, bbox_inches="tight")
    fig.savefig(OUT_DIR / "free_energy_10GPa_1500K_1800K_with_config_entropy.pdf", bbox_inches="tight")
    plt.close(fig)
