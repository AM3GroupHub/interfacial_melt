...
def plot_energy_composition(files, reference_formula, temperature, output_prefix):
    ...
    P0 = -8.071581312000001
    P1 = -6.442256819444444
    
    ent0 = -7.1645288680000005
    ent1 = -5.804338159722223
    ...
    if data_ent:
        ...
        plot_one_panel(
            ...
            color_points="green",
            color_line_default="red",
            title=f'Enthalpy vs x({reference_formula}) at {temperature} K and 10 GPa',
