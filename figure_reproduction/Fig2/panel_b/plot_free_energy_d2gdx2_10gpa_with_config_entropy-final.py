...
ENERGY_SOURCE = ROOT / "data" / "normalized_energy_10GPa_liquid.csv"
D2G_SOURCE = ROOT / "data" / "dgmix_recon_10GPa.csv"
...
def main():
    ...
    fig, axes = plt.subplots(2, 2, figsize=(3.25, 2.5), sharex="col", gridspec_kw={"height_ratios": [1.6, 0.9]})
    ...
    out_path = OUTPUT_DIR / "free_energy_d2g_10GPa_1500K_1800K_with_config_entropy.pdf"
    fig.savefig(out_path, dpi=600, bbox_inches="tight")
    fig.savefig(OUTPUT_DIR / "free_energy_d2g_10GPa_1500K_1800K_with_config_entropy.png", dpi=600, bbox_inches="tight")
    plt.close(fig)
